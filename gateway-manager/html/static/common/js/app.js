...
$.app.ajax = function(urlstr, datastr, method, datatype, fn, ignoreerror, progressing, requestHeader){
...
function triggerNavMenuClick(navtitle, iaccordtitle, menutitle, submenutitle, refresh){
	let arg = [navtitle, iaccordtitle, menutitle, submenutitle, null, refresh]
...
function closeAndTriggerNavMenuClick(navtitle, iaccordtitle, menutitle, submenutitle){
